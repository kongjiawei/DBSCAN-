...
if (__name__ == '__main__'):
    ...
    Y_train = DataY
    model = Sequential()
    model.add(Dense(N_HIDDEN1, input_shape = (INPUT_SHAPE, )))
    ...
    history = model.fit(X_train, Y_train, batch_size = BATCH_SIZE,
                        epochs = 2100, verbose = 1, validation_split = VALIDATION_SPLIT)
